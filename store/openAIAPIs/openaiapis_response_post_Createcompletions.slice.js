...
export const openaiapis_post_v1_completions_create = createAsyncThunk("openaiapis_response_post_Createcompletions/openaiapis_post_v1_completions_create", async payload => {
  const response = await apiService.openaiapis_post_v1_completions_create(payload);
