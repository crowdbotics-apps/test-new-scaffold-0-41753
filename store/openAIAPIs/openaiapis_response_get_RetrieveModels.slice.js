...
export const openaiapis_get_v1_models_model_read = createAsyncThunk(
  "openaiapis_response_get_RetrieveModels/openaiapis_get_v1_models_model_read",
  async payload => {
    const response = await apiService.openaiapis_get_v1_models_model_read(
      payload
    )
