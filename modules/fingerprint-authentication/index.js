  ...
  const authCurrent = () => {
    FingerprintScanner.authenticate({
      ...
      if (Platform.OS === "android") {
        Alert.alert("Authenticated Successfully!", "Fingerprints have been matched and verified successfully");
      } else {
        AlertIOS.alert("Authenticated Successfully!", "Fingerprints have been matched and verified successfully");
      }
